...
class ApplicationWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.InsertImage.clicked.connect(lambda: self.Add_Img(6))
        self.CannyOut.clicked.connect(self.DetectCanny)
        #Snake tab
        ...
        if self.image_path:
            ...
            if index==1:
               ...
               self.hough_img_label.setPixmap(pixmap)
                ...
                self.canny_img = cv2.imread(self.image_path)
                self.inserted_img.setPixmap(pixmap)
    ...
    def DetectCanny(self):
        ...
        pixmap = QPixmap("canny.jpg")
        self.show_canny.setPixmap(pixmap)
